...
if PLATFORM == 'gcc':
    ...
    NM = PREFIX + 'nm'
    DEVICE = ' -mcpu=cortex-r52 -marm -mfloat-abi=hard -mfpu=neon-fp-armv8 -fdiagnostics-parseable-fixits -O2 -fmessage-length=0 -fsigned-char -fdata-sections -funwind-tables -ffunction-sections -fno-strict-aliasing -g1 -gdwarf-4'
    CFLAGS = DEVICE + ' -Dgcc'
