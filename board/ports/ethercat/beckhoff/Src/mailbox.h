...
PROTO UINT8 PutInMbxQueue(TMBX MBXMEM * pMbx, TMBXQUEUE MBXMEM * pQueue);
PROTO TMBX MBXMEM * GetOutOfMbxQueue(TMBXQUEUE MBXMEM * pQueue);
PROTO UINT8 MailboxServiceInd(TMBX MBXMEM *pMbx);
