...
#define Entry_Number_0x1600 5
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[Entry_Number_0x1600]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1600;


/** \brief 0x1601 (csp RxPDO) data structure*/
#define Entry_Number_0x1601 10
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[Entry_Number_0x1601]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1601;


/** \brief 0x1602 (csv RxPDO) data structure*/
#define Entry_Number_0x1602 9
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[Entry_Number_0x1602]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1602;


/** \brief 0x1A00 (csp/csv TxPDO) data structure*/
#define Entry_Number_0x1A00 5
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[Entry_Number_0x1A00]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1A00;


/** \brief 0x1A01 (csp TxPDO) data structure*/
#define Entry_Number_0x1A01 10
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[Entry_Number_0x1A01]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1A01;


/** \brief 0x1A02 (csv TxPDO) data structure*/
#define Entry_Number_0x1A02 9
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[Entry_Number_0x1A02]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1A02;
/** @}*/
...
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16    u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32    u32PhysicalOutputs; /**< \brief Physical outputs*/
   UINT32    u32BitMask; /**< \brief Bit mask*/
} OBJ_STRUCT_PACKED_END
TOBJ60FE;
/** @}*/
...
typedef struct STRUCT_PACKED_START
{
    ...
    INT8 ObjModesOfOperationDisplay; /**< \brief Current mode of operation (0x6061)*/
...
typedef struct STRUCT_PACKED_START
{
    ...
    UINT32 ObjDigitalOutputs; /**< \brief Physical outputs (0x60FE:01)*/
}STRUCT_PACKED_END
TCiA402PDO1600;
#pragma pack()
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST UCHAR OBJMEM aName0x1600[] = "csp/csv RxPDO Mapping\000\377";
...
OBJCONST TSDOINFOENTRYDESC	OBJMEM asEntryDesc0x1601[] = {
   ...
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ}}; /* SubIndex 0010*/
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST UCHAR OBJMEM aName0x1601[] = "csp RxPDO Mapping\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST UCHAR OBJMEM aName0x1602[] = "csv RxPDO Mapping\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST UCHAR OBJMEM aName0x1A00[] = "csp/csv TxPDO Mapping\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST UCHAR OBJMEM aName0x1A01[] = "csp TxPDO Mapping\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST UCHAR OBJMEM aName0x1A02[] = "csv TxPDO Mapping\000\377";
/** @}*/
 ...
 * 
 * Subindex 0<br>
 * Subindex 1 : Physical outputs<br>
 * Subindex 2 : Bit mask
 */
...
OBJCONST UCHAR OBJMEM aName0x60FE[] = "Digital Outputs\000Physical outputs\000Bit mask\000\377";
/** @}*/
...
/** \brief Object 0xF000 (Semiconductor Device Profile) object and entry names*/
...
/**
 * \brief 0xF050 (Detected Module Ident List) object name
 *
 * no entry names defined because the object is an array (for every entry > 0 "SubIndex xxx" is returned)
 */       
OBJCONST UCHAR OBJMEM aName0xF050[] = "Detected Module Ident List";
/** @}*/
#endif
...
#ifdef _CiA402_
= {
{Entry_Number_0x1600, {0x60400010,0x607A0020,0x60FF0020,0x60600010,0x60FE0020}},    /* TOBJ1600*/
{Entry_Number_0x1601, {0x60400010,0x60720010,0x607A0020,0x60B00020,0x60B10020,0x60B20010,0x60B80010,0x60E00010,0x60E10010,0x60FE0020}}, /*TOBJ1601*/
{Entry_Number_0x1602, {0x60400010,0x60720010,0x60B10020,0x60B20010,0x60B80010,0x60E00010,0x60E10010,0x60FE0020,0x60FF0020}}, /*TOBJ1602*/
{Entry_Number_0x1A00, {0x60FD0020,0x60410010,0x60640020,0x606C0020,0x60610010}}, /*TOBJ1A00*/
{Entry_Number_0x1A01, {0x603F0010,0x60410010,0x60640020,0x606C0020,0x60770010,0x60B90010,0x60BA0020,0x60BC0020,0x60F40020,0x60FD0020}}, /*TOBJ1A01*/
{Entry_Number_0x1A02, {0x603F0010,0x60410010,0x60640020,0x606C0020,0x60770010,0x60B90010,0x60BA0020,0x60BC0020,0x60FD0020}},/*TOBJ1A02*/
...
{2,(INT32)0x88CA6C00,0x77359400},/*TOBJ607B Position range limit (minLimit: -2000000000 / maxLimit: 2000000000)*/
0x0,/*(INT32) Home Offset 0x607C*/
{2,(INT32)0x88CA6C00,0x77359400},/*TOBJ607D Software Position Limit (minLimit: -2000000000 / maxLimit: 2000000000)*/
...
= {
    /* Object 0x1600 */
    {NULL,NULL, 0x1600, {DEFTYPE_PDOMAPPING, Entry_Number_0x1600 | (OBJCODE_REC << 8)}, asEntryDesc0x1600, aName0x1600, NULL, NULL, NULL, 0x0000 },
    /* Object 0x1601 */
   {NULL,NULL, 0x1601, {DEFTYPE_PDOMAPPING, Entry_Number_0x1601 | (OBJCODE_REC << 8)}, asEntryDesc0x1601, aName0x1601,NULL, NULL, NULL, 0x0000 },
    /* Object 0x1602 */
   {NULL,NULL, 0x1602, {DEFTYPE_PDOMAPPING, Entry_Number_0x1602 | (OBJCODE_REC << 8)}, asEntryDesc0x1602, aName0x1602, NULL, NULL, NULL, 0x0000 },
   /* Object 0x1A00 */
   {NULL,NULL, 0x1A00, {DEFTYPE_PDOMAPPING, Entry_Number_0x1A00 | (OBJCODE_REC << 8)}, asEntryDesc0x1A00, aName0x1A00, NULL, NULL, NULL, 0x0000 },
   /* Object 0x1A01 */
   {NULL,NULL, 0x1A01, {DEFTYPE_PDOMAPPING, Entry_Number_0x1A01 | (OBJCODE_REC << 8)}, asEntryDesc0x1A01, aName0x1A01, NULL, NULL, NULL, 0x0000 },
   /* Object 0x1A02 */
   {NULL,NULL, 0x1A02, {DEFTYPE_PDOMAPPING, Entry_Number_0x1A02 | (OBJCODE_REC << 8)}, asEntryDesc0x1A02, aName0x1A02, NULL, NULL, NULL, 0x0000 },
   /* Object 0x603F */
...
PROTO BOOL CiA402_TransitionAction(INT16 Characteristic,TCiA402Axis *pCiA402Axis);
