...
extern const UINT32 tbl_identify[4];
#define ID_VENDOR   (0)
#define ID_PRODUCT  (1)
...
PROTO void SetALEventMask(UINT16 intMask);
PROTO void UpdateEEPROMLoadedState(void);
PROTO UINT8    CheckSmSettings(UINT8 maxChannel);
PROTO UINT16 StartInputHandler(void);
PROTO UINT16 StartOutputHandler(void);
PROTO void StopOutputHandler(void);
PROTO void StopInputHandler(void);
PROTO void BackToInitTransition(void);
PROTO void AL_ControlRes(void);
