...
/**
SSC_FORCE_FREERUN: RT-Thread polling-port bring-up switch.
The v4 port connects the LAN9252 AL Event IRQ to a deferred PDI service in the SSC thread, so this remains disabled.
*/
#ifndef SSC_FORCE_FREERUN
#define SSC_FORCE_FREERUN                        0
#endif
...
#define MIN_PD_CYCLE_TIME                         0x0000C350    // 50 us (50000 ns)
#endif
