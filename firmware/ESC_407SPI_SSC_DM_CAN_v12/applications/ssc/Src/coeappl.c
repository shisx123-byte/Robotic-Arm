...
void COE_ObjInit(void)
{
    ...
    /* The v5 port supports FreeRun, SyncManager synchronisation and
     * LAN9252 distributed-clock SYNC0/SYNC1 GPIO events. */
    sSyncManOutPar.u16SyncTypesSupported    = SYNCTYPE_FREERUNSUPP
                                              | SYNCTYPE_TIMESVARIABLE
                                              | SYNCTYPE_SYNCHRONSUPP
                                              | SYNCTYPE_DCSYNC0SUPP
                                              | SYNCTYPE_DCSYNC1SUPP
                                              | SYNCTYPE_SUBCYCLESUPP;
